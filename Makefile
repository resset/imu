...
ifeq ($(USE_COPT),)
  USE_COPT = -std=c99 -Wall -Wshadow -Wextra
endif
...
include ./boards/DevEBox_H743/board.mk
...
# Remove for non revision X or Y devices.
UDEFS = -DSTM32_ENFORCE_H7_REV_XY -DSHELL_CMD_TEST_ENABLED=FALSE -DSHELL_CONFIG_FILE
